...
def test_item_click_buzz(browser):
    ...
    buzz_tab_button = browser.find_element(By.XPATH, '//*[@id="app"]/div[1]/div[1]/aside/nav/div[2]/ul/li[12]/a/span')
    time.sleep(1)
    buzz_tab_button.click()
    time.sleep(1)
    buzz_tab = browser.find_element(By.XPATH, '//*[@id="app"]/div[1]/div[2]/div[2]')

    assert buzz_tab.is_displayed(), ""
