...
def test_item_click_dashboard(browser):
    ...
    dashboard_tab_button = browser.find_element(By.XPATH, '//*[@id="app"]/div[1]/div[1]/aside/nav/div[2]/ul/li['
                                                          '8]/a/span')
    time.sleep(1)
    dashboard_tab_button.click()
    time.sleep(1)
    dashboard_tab = browser.find_element(By.XPATH, '//*[@id="app"]/div[1]/div[2]/div[2]')

    assert dashboard_tab.is_displayed(), ""
