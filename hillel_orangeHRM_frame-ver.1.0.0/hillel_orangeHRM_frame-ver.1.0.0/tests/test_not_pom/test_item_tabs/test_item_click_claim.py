...
def test_item_click_claim(browser):
    ...
    claim_tab_button = browser.find_element(By.XPATH, '//*[@id="app"]/div[1]/div[1]/aside/nav/div[2]/ul/li[11]/a/span')
    time.sleep(1)
    claim_tab_button.click()
    time.sleep(1)
    claim_tab = browser.find_element(By.XPATH, '//*[@id="app"]/div[1]/div[2]/div[2]')

    assert claim_tab.is_displayed(), ""
