...
def test_item_click_time(browser):
    ...
    time_tab_button = browser.find_element(By.XPATH, '//*[@id="app"]/div[1]/div[1]/aside/nav/div[2]/ul/li[4]/a/span')
    time.sleep(1)
    time_tab_button.click()
    time.sleep(1)
    time_tab = browser.find_element(By.XPATH, '//*[@id="app"]/div[1]/div[2]/div[2]')

    assert time_tab.is_displayed(), ""
