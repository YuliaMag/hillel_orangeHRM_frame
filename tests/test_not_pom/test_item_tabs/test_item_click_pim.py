...
def test_item_click_pim(browser):
    ...
    pim_tab_button = browser.find_element(By.XPATH, '//*[@id="app"]/div[1]/div[1]/aside/nav/div[2]/ul/li[2]/a/span')
    time.sleep(1)
    pim_tab_button.click()
    time.sleep(1)
    pim_tab = browser.find_element(By.XPATH, '//*[@id="app"]/div[1]/div[2]/div[2]')

    assert pim_tab.is_displayed(), ""
