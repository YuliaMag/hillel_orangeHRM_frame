...
def test_item_click_leave(browser):
    ...
    leave_tab_button = browser.find_element(By.XPATH, '//*[@id="app"]/div[1]/div[1]/aside/nav/div[2]/ul/li[3]/a/span')
    time.sleep(1)
    leave_tab_button.click()
    time.sleep(1)
    leave_tab = browser.find_element(By.XPATH, '//*[@id="app"]/div[1]/div[2]/div[2]')

    assert leave_tab.is_displayed(), ""
